      ...
      <div class="container">
        <el-form class="login-form" :model="ruleForm2" ref="ruleForm2" :rules="rules2">
          ...
          <el-form-item prop="username">
            <el-input type="text" class="inputs" placeholder="请输入帐号" v-model="ruleForm2.username"
          ...
          <el-form-item v-if="visible" prop="password">
            <el-input type="password" v-model="ruleForm2.password" placeholder="请输入密码" autocomplete="off">
              <i slot="suffix" title="显示密码" @click="changePass('show')" class="el-icon-view"></i>
            </el-input>
          </el-form-item>
          <el-form-item v-else prop="password">
            <el-input type="text" v-model="ruleForm2.password" placeholder="请输入密码" autocomplete="off">
              <i slot="suffix" title="隐藏密码" @click="changePass('hide')" class="el-icon-view"></i>
            </el-input>
          </el-form-item>
          ...
          <el-form-item prop="phone">
            <el-input type="text" class="inputs" placeholder="请输入电话" v-model="ruleForm2.phone"
              autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item prop="email">
            <el-input type="text" class="inputs" placeholder="请输入邮箱" v-model="ruleForm2.email"
              autocomplete="off"></el-input>
          </el-form-item>
          <div class="btn-box">
